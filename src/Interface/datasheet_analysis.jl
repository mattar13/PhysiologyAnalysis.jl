...
# ╔═╡ 8e541b68-96f6-4f6b-a179-92053543c45f
md"
## 2) Point to the datasheet containing the file analysis
"

# ╔═╡ 7b8d0a3e-a26e-4407-a696-12481be51ccf
datasheet_root = nothing;

# ╔═╡ b0a56828-ec6e-4283-94b7-765a47ae5e95
md"
#### b) specify the:
- Year
"

# ╔═╡ ab48cfac-9c54-4d9d-82b9-d1a5c6cadf7d
md"
- Month
"

# ╔═╡ 328e7701-9fcc-4baf-afc3-fc740166af59
md"
- Date
"

# ╔═╡ 3a33f12f-7464-4e0a-b1f5-686d9bd99542
md"
- Number
"

# ╔═╡ 03cf000f-5672-41f2-baf3-d31f65e6a6f6
md"
- Channel
"

# ╔═╡ 01fab469-e7c3-4573-9e75-d2d13c7ff3de
all_files = createDatasheet(exp_root |> parseABF; filename = nothing);
...
# ╔═╡ 9a4404cf-e5d2-49e2-91c2-b99ba347e452
#Manually setting the fitting numbers
...
begin
	...
	if length(channels) > 1
		for (ch, name) in enumerate(dataAB.chNames)
			...
			ax2[ch,3].scatter(ch_trace_B.Photons, ch_trace_B.Maxima, 
				s = 4.0, c = :black
			)
