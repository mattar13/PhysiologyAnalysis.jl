...
begin
	...
	import NeuroAnalysis: fft_spectrum
	#Use pyplot? for plotting
	using PyPlot
	import NeuroAnalysis.plot_experiment
	#import PyPlot: plt
	import NeuroAnalysis.rcParams
	import NeuroAnalysis: wavelet, cDb2
...
begin
	#settings
	wave = NeuroAnalysis.Morlet(0.50π)
    ...
    for ch in 1:size(data, 3)
		CWT_PROC = NeuroAnalysis.CWTprocess(CWTi[1, :, :, ch])
